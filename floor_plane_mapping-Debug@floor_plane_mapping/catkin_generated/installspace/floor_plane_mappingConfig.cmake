...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY /usr/local/${idir})
      ...
      message(FATAL_ERROR "Project 'floor_plane_mapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'cedricp <cedric.pradalier@georgiatech-metz.fr>' to fix it.")
    endif()
